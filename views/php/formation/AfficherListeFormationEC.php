                ...
                <div class="side-bar">
                    ...
                    <nav class="side-menu">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="AfficherListeFormationEC.php"><span class="fa fa-spinner" aria-hidden="true"></span> Formations en attente</a></li>
                            <li ><a href="#"><span class="fa fa-check-square-o" aria-hidden="true"></span> Formations accéptées</a></li>
                ...
                <div class="content-panel">
                    <div class="content-header-wrapper">
                        ...
                        <div class="actions" >
                            ...
                            <button class="btn" ><a href="FormAjoutFormation.php" class="btnn"><i class="fa fa-plus" ></i> Ajouter une formation</button>
                        </div>
                    </div>
...
?>
                    ...
                    <a href="supprimerFormationEC.php?id_formation=<?php echo $formation['id_formation']; ?>" class="btn">Supprimer</a>

                          ...
                          <div class="table-wrap">
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                ?>
                                <form action="AfficherCours.php?id_formation=<?php echo $formation['id_formation']; ?>" method="POST">
                                  <tr class="alert" role="alert">
                                    <td>
                                      ...
                                      ?>
                                        <a href="#" data-toggle="collapse" data-target=".forum-content"> <?php echo "<image src='" . $id_formation . ".jpg' class='mr-3 rounded-circle' width='1%' alt='User'>"; ?> </a>
                                      <?php
                                      }
                                      ?>
                                    </td>
                                    <td>
                                      <div class="email">
                                        <span><?php echo $formation['titre_f']; ?> </span>
                                        <span><?php echo $formation['descreptions']; ?></span>
                                      </div>
                                    </td>
                                    <td><?php echo $formation['date_c']; ?></td>
                                    <td><?php echo $formation['prix_f']; ?></td>
                                    <td>
                                    ...
                                    <td>
                                    <button type="submit" value="SubmitA">Les cours</button>
                                    </td>
                                  </tr>
                                  </form>
                                <?php

...
<body>
	...
	?> 
				...
				<div class="div_tel">
					<a href="telechargerCours.php?url=../formation/uploads/<?php echo $cours['contenuCours'];?>&level=<?php echo $l?>"> <button class="button-telecharger" role="button">Télécharger le contenue</button></a>

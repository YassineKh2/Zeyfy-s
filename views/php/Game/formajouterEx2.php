...
<link rel="stylesheet" href="../../assets/css/formex.css">
</head>
<body>
...
<div class="row">
    <div class="col-md-12">
      <form method="post">
        <h1> Nouvelle Exercice </h1>
        
        <fieldset>
          
          <legend><p class="number">1</p> Exercice</legend>
        
          <label>Name Exercice</label>
          <input type="text" name="nom_ex">
        
          <label >Contenu Exercice</label>
          <textarea id="contenu" name="ex_contenue"></textarea>
        
       
          <label>Solution</label>
          <textarea id="solution" name="ex_solution"></textarea>
    
        </fieldset>
        <fieldset>  
        
          <legend><p class="number">2</p> Categorie</legend>

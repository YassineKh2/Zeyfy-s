                ...
                <div class="side-bar">
                    ...
                    <nav class="side-menu">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="#"><span class="fa fa-times" aria-hidden="true"></span> Formations Refusées</a></li>
                ...
                <div class="content-panel">
                    ...
                    <div class="card-body p-2 p-sm-3">
                        <div class="media forum-item">
                            ...
                            <a href="supprimerFormationR.php?id_formation=<?php echo $formation['id_formation']; ?>" class="btn">Supprimer</a>
